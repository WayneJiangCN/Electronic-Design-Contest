...
{
    //读出行扫描状态
    Key_row[0] = HAL_GPIO_ReadPin(KEY_row0_GPIO_Port,KEY_row0_Pin)<<3;
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(KEY_row1_GPIO_Port,KEY_row1_Pin)<<2);
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(KEY_row2_GPIO_Port,KEY_row2_Pin)<<1);
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(KEY_row3_GPIO_Port,KEY_row3_Pin));
